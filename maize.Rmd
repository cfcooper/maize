...
#dat$land_type[is.na(dat$land_type)] <- 0
#dat$land_type <- sub("^$", 0, dat$land_type)

#dat$land_type <- if_else(dat$land_type == "Irrigation", 1, 0)
#dat$irrigated <- if_else(dat$land_type == 1, 1, dat$irrigated)

dat$yearsq <- dat$year*dat$year
dat <- dat[c("year", "yearsq", "region", "provence", "locality", "locality_no", "cultivar_name", "alternate", "cultivar_no", "cultivar_br", "rep", "yield", "color", "technology", "crop", "temp", "irrigated", "number", "release_year", "land_type")]
